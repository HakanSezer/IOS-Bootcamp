...
class Anasayfa: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        _ = viewModel.kisilerListesi.subscribe(onNext: { liste in
            ...
            // Bu bizim performanslı bir şekilde çalışmamızı sağlıyoruz.
            // Bunu sayesinde aldığımız listeyi çalıştırır ama olmasada çalışır hata vermezse 
    ...
    func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        let silAction = UIContextualAction(style: .destructive, title: "Sil") { contextAction, view, bool in
            ...
            let evetAction = UIAlertAction(title: "Evet", style: .destructive) { action in
                self.viewModel.sil(kisiID: Int(kisi.kisi_id!)!)
            }
